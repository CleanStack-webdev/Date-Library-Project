...
public:
	...
	static void PrintFormattedDate(clsDate Date, enDateFormat formattedDate = LabeledDate, string Delim = "/")
	{
		cout << "\n";

		if (formattedDate == LabeledDate)
		...
		if (formattedDate != LabeledDate)
		{
			...
			{
			case DayMonthYear:
				cout << Date.Day << Delim << Date.Month << Delim << Date.Year << endl;
				break;
			case YearDayMonth:
				cout << Date.Year << Delim << Date.Day << Delim << Date.Month << endl;
				break;
			case MonthDayYear:
				cout << Date.Month << Delim << Date.Day << Delim << Date.Year << endl;
				break;
			}
		}
	}

	static string FormatDateUsingEnums(clsDate Date, enDateFormat formattedDate = LabeledDate, string Delim = "/")
	{
		cout << "\n\n";
		...
		if (formattedDate == LabeledDate)
			DateString = "Day:" + to_string(Date.Day) + ", Month:" + to_string(Date.Month) + ", Year:" + to_string(Date.Year);
		...
		if (formattedDate != LabeledDate)
		{
			...
			{
			case DayMonthYear:
				DateString = to_string(Date.Day) + Delim + to_string(Date.Month) + Delim + to_string(Date.Year);
				break;
			case YearDayMonth:
				DateString = to_string(Date.Year) + Delim + to_string(Date.Day) + Delim + to_string(Date.Month);
				break;
			case MonthDayYear:
				DateString = to_string(Date.Month) + Delim + to_string(Date.Day) + Delim + to_string(Date.Year);
				break;
			}
		}
